...
/* Disparo rápido: un impacto al 50% de daño con velocidad de ataque ×2. */
CLASS_FICHAS.archer.passives=CLASS_FICHAS.archer.passives.map(p=>p==='Emboscada'?'Disparo rápido':p);
PASSIVE_DESCRIPTIONS['Disparo rápido']='Activa: duplica la velocidad de ataque, pero cada ataque básico inflige el 50% del daño. Por sí sola mantiene el mismo daño por segundo y permite activar efectos de impacto con más frecuencia.';
